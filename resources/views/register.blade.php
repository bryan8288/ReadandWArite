...
<body>
    ...
    <div class="col-lg-12" style="background-image: url('/storage/Image/background.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; padding-bottom: 500px; padding-top: 50px; margin-top: 20px">
        <div class="col-md-12">
            <form method="post" style="text-align: center; background-color: white; padding-top: 20px; padding-bottom: 50px">
                {{csrf_field()}}
                ...
                <div class="container" style="margin-top: 30px">
                    <div style="display: flex">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Name" name="name" required style="width: 800px; margin-left: 100px">
                    </div>
                    <div style="display: flex">
                        <label for="email" style="margin-top: 10px"><b>E-Mail Address</b></label>
                        <input type="text" class="form-control" placeholder="Enter E-Mail Address" name="email" required style="width: 800px; margin-top: 5px; margin-left: 32px">
                    </div>
                    <div style="display: flex">
                        <label for="psw" style="margin-top: 10px"><b>Password</b></label>
                        <input type="password" class="form-control" placeholder="Enter Password" name="password" required style="width: 800px; margin-top: 5px; margin-left: 73px">
                    </div>
                    <div style="display: flex">
                        <label for="confpass" style="margin-top: 10px"><b>Confirm Password</b></label>
                        <input type="password" class="form-control" placeholder="Confirm Password" name="password_confirmation" required style="width: 800px; margin-top: 5px; margin-left: 8px">
                    </div>
                    <div>
                        <button type="submit" class="btn btn-primary" style="width: 150px; height: 40px; margin-top: 10px">Register</button>
                    </div>
