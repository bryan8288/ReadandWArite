...
<body>
    ...
    <div class="col-lg-12" style="background-image: url('/storage/Image/background.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; padding-bottom: 500px; padding-top: 30px; margin-top: 20px;">
        <div class="col-md-12" style="display: flex;">
            ...
            <div class="col-md-6">
                <form action="{{url('/addStationaryType/add')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Stationary Type Name" style="margin-bottom: 5px">
                    <button class="btn btn-primary" style="margin-bottom: 5px">Add New Stationary Type</button>
                </form>
            </div>
        </div>
        @if(count($errors) > 0)
